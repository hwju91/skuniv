...
<head>
	<title>Profile | KingAdmin - Admin Dashboard</title>
	<meta charset="utf-8">
...
<body >
			...
			<div class="row">
				<div class="col-lg-4 ">
					<ul class="breadcrumb">
						...
						<li><a href="projectlist">Project list</li>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="user-info-left">
										<img src="img2/profile-avatar.png" alt="Profile Picture" />
										<h2>team_user name <i class="fa fa-circle green-font online-icon"></i><sup class="sr-only">online</sup></h2>
										<div class="contact">
	...
	<script src="js2/plugins/modernizr/modernizr.js"></script>
	...
	<script src="js2/king-common.js"></script>
	<script src="demo-style-switcher/assets/js/deliswitch.js"></script>
	<script src="js2/plugins/bootstrap-switch/bootstrap-switch.min.js"></script>
</body>
