		...
		<div id="main-content-wrapper" class="content-wrapper ">
			...
			<div class="content">
				<div class="col-md-12">
					...
					<h2><%=request.getParameter("teamno") %></h2>
					<input type="hidden" name="tno" value="<%=request.getParameter("teamno") %>">
					<em><a href="projectlist"><button type="submit" class="btn btn-sm btn-primary pull-right"><i class="fa fa-edit"></i> Project list</button></a></em>
