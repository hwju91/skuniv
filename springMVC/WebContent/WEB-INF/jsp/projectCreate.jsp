...
<div class="row" id="tagtest">
    <div class="col-md-12">
        <h4 class="page-head-line">make project form</h4>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                   <h4> Login with facebook <strong> / </strong>Google :</h4>
                    ...
                    <hr />
                     <h4>  <strong>Make project  :</strong></h4>
                    <br />
                     ...
                     <label>New project title : </label>
                        ...
                        <input type="hidden" name="makeuserid" value="test">
                        <input type="text" name="projectdeadline" class="form-control" />
