...
<div class="row">
	<div class="col-md-12">
		<h4 class="page-head-line">project&nbsp;&nbsp;&nbsp;&nbsp; <a href="projectform?tno=${tno }" class="btn btn-primary">+create project</a></h4>
	</div>
</div>
...
<div class="row">
	<c:forEach items="${plist }" var="plist">
		...
		<div class="panel panel-success">
			...
			<a href="projectmain?pno=${plist.pno }"><img src="img/test1.jpg"></a> 
